...
public interface IRestfulEndpoint<TIn, TOut>
{
    ...
    /// </returns>
    Task<Result<TOut>> RunAsync(TIn input);
}
...
public abstract class RestfulEndpoint<TIn, TOut> : IRestfulEndpoint<TIn, TOut>
{
    ...
    /// </returns>
    public virtual async Task<Result<TOut>> RunAsync(TIn input)
    {
    ...
    protected abstract Task<Result<TOut>> ProccessFailureResponseAsync(HttpResponse response);
